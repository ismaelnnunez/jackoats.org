...
const customControl = L.Control.extend({
	options: {
		...
		style: "box-sizing: border-box; margin-top: 5px; left: 0; padding: 4px; display: flex; cursor: pointer; justify-content: center; font-size: 2rem; width: 34px; height: 34px; background: #fff"},
